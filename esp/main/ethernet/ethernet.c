...
static esp_err_t spi_bus_init(void) {
    ...
    spi_bus_config_t buscfg = {
        .miso_io_num = CONFIG_W5500_MISO,
        .mosi_io_num = CONFIG_W5500_MOSI,
        .sclk_io_num = CONFIG_W5500_SCLK,
        .quadwp_io_num = -1,
        .quadhd_io_num = -1,
    };
    ESP_GOTO_ON_ERROR(spi_bus_initialize(SPI2_HOST, &buscfg, SPI_DMA_CH_AUTO),
        err, TAG, "SPI host #%d init failed", SPI2_HOST);
...
static esp_err_t eth_init(esp_eth_handle_t *eth_handles_out[], uint8_t *eth_cnt_out) {
    esp_err_t ret = ESP_OK;
    ...
    spi_eth_module_config_t spi_eth_module_config[1] = {
        {
            .int_gpio = CONFIG_W5500_INT,
            .phy_addr = 1,
            .phy_reset_gpio = -1,
            .polling_ms = 0,
            .spi_cs_gpio = CONFIG_W5500_SS
        }
    };
...
static void got_ip_event_handler(void *arg, esp_event_base_t event_base,
    ...
    ledSetWiFiState(true);
    if (gotIp != NULL)
        xEventGroupSetBits(gotIp, BIT0);
}
...
esp_err_t ethernetInit(EventGroupHandle_t gotIp_) {
    gotIp = gotIp_;
